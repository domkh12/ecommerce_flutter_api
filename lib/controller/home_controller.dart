...
import 'package:my_app_ecommerce/model/category.dart';
import 'package:my_app_ecommerce/model/product.dart';
import 'package:my_app_ecommerce/service/local_service/local_ad_banner_service.dart';
import 'package:my_app_ecommerce/service/local_service/local_category_service.dart';
import 'package:my_app_ecommerce/service/local_service/local_product_service.dart';
import 'package:my_app_ecommerce/service/remote_service/remote_banner_service.dart';
import 'package:my_app_ecommerce/service/remote_service/remote_popular_category_service.dart';
import 'package:my_app_ecommerce/service/remote_service/remote_popular_product_service.dart';
  ...
  void getAdBanner() async {
    try {
      ...
      if (result != null) {
        ...
        _localAdBannerService.assignAllAdBanner(
