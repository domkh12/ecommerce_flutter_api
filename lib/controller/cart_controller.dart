...
import 'package:my_app_ecommerce/model/cart_item.dart';
import 'package:my_app_ecommerce/model/tag.dart';
import 'package:my_app_ecommerce/service/remote_service/remote_cart_service.dart';
...
class CartController extends GetxController {
    ...
    try {
      ...
      if (item != null) {
        CartItem newItem = CartItem(
            quantity: (quantity + item.quantity), product: product, tag: tag);
  ...
  void removeCart(
      {required int index, required int itemId, required String token}) {
    try {
