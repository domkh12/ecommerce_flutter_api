...
import 'package:my_app_ecommerce/service/local_service/local_auth_service.dart';
import 'package:my_app_ecommerce/service/remote_service/remote_auth_service.dart';
    ...
    try {
      ...
      if (result.statusCode == 200) {
        ...
        if (userResult.statusCode == 200) {
          ...
          EasyLoading.showSuccess("Welcome to Ya Cosmetic!");
